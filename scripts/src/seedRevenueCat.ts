...
const PROJECT_NAME = "Sacred Words";

const PRODUCT_IDENTIFIER = "sacred_words_premium_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "sacred_words_premium_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "Sacred Words Premium";
const PRODUCT_USER_FACING_TITLE = "Sacred Words Premium";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "Sacred Words iOS";
const APP_STORE_BUNDLE_ID = "com.sacredwords.app";
const PLAY_STORE_APP_NAME = "Sacred Words Android";
const PLAY_STORE_PACKAGE_NAME = "com.sacredwords.app";
...
async function seedRevenueCat() {
  ...
  if (priceError) {
    const e = priceError as Record<string, unknown>;
  ...
  if (attachEntitlementError) {
    const e = attachEntitlementError as Record<string, unknown>;
  ...
  if (attachPackageError) {
    const e = attachPackageError as Record<string, unknown>;
    if (typeof e["message"] === "string" && (e["message"] as string).includes("Cannot attach product")) {
  ...
  console.log("\n====================");
  console.log("Sacred Words RevenueCat setup complete!");
