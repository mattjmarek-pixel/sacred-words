...
export const getGeneratePrayerMutationOptions = <
  TError = ErrorType<FreeTierLimitReached>,
  TContext = unknown,
>(options?: {
...
export type GeneratePrayerMutationError = ErrorType<FreeTierLimitReached>;
 ...
 */
export const getGetPrayerUsageUrl = () => {
  return `/api/prayers/usage`;
};

export const getPrayerUsage = async (
  options?: RequestInit,
): Promise<PrayerUsage> => {
  return customFetch<PrayerUsage>(getGetPrayerUsageUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetPrayerUsageQueryKey = () => {
  return [`/api/prayers/usage`] as const;
};

export const getGetPrayerUsageQueryOptions = <
  TData = Awaited<ReturnType<typeof getPrayerUsage>>,
  TError = ErrorType<ErrorEnvelope>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getPrayerUsage>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetPrayerUsageQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getPrayerUsage>>> = ({
    signal,
  }) => getPrayerUsage({ signal, ...requestOptions });
...
export type GetPrayerUsageQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPrayerUsage>>
>;
export type GetPrayerUsageQueryError = ErrorType<ErrorEnvelope>;

/**
 * @summary Get the current user's prayer generation usage for this month
 */

export function useGetPrayerUsage<
  TData = Awaited<ReturnType<typeof getPrayerUsage>>,
  TError = ErrorType<ErrorEnvelope>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetPrayerUsageQueryOptions(options);
